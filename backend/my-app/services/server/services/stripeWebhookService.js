...
import { sendOneTimePurchaseEmail, sendSubscriptionWelcomeEmail, sendSubscriptionCancellationEmail, sendSubscriptionReinstatementEmail } from '../email.js';
...
export async function handleSubscriptionUpdated(subscription) {
  ...
  if (localSubscription) {
    ...
    // Send welcome email if subscription just became active
