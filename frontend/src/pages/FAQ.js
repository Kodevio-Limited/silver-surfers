                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="mb-12">
                            <h1 className="heading-hero text-white mb-6">
                                <span
                                    className="block bg-gradient-to-r from-blue-300 via-green-400 via-teal-300 to-cyan-400 bg-clip-text text-transparent leading-tight"
            ...
            <section className="faq-section">
                <div className="faq-content">
                    ...
                    {!loading &&
                        !error &&
                        faqData.map((faq, idx) => (
                            <div key={faq._id || idx} className={`faq-item ${expandedFaq === (faq._id || idx) ? "expanded" : ""}`}>
                                <button type="button" className="faq-button" onClick={() => toggleFaq(faq._id || idx)}>
                    ...
                    {!loading && !error && faqData.length === 0 && <div className="text-center text-gray-700">No FAQs published yet.</div>}
                </div>
            </section>
                ...
                <div className="resources-container">
                    ...
                    <div className="resources-grid">
                        <div className="resource-card">
                            ...
                            <button type="button" onClick={() => (window.location.href = "/blog")} className="resource-button">
                                Read Blog →
                            </button>
                        </div>
                    </div>
